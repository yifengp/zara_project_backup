...
const ProductDetailPage: React.FC<ProductDetailPageProps> = ({ products, onAddToCart }) => {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/best-sellers" className="text-blue-600 hover:underline">
  ...
  const handleCloseOverlay = () => {
    ...
    // Don't reset hasAddedToCart - keep the COMPLETE ORDER button visible
  };
  ...
  const getRelatedProducts = () => {
    // Return related Woman products based on current product
      ...
      const relatedProducts: Product[] = [
        {
          ...
          images: ['/SEQUIN MINI Skirt copy copy.jpg'],
          category: 'Woman',
          sizes: ['XS', 'S', 'M', 'L', 'XL'],
    ...
    // Default related products for other items
            ...
            <div className="flex-1">
              ...
              <div className="mb-8">
                <div className="text-sm text-gray-600 tracking-wide">
                  {selectedColor.toUpperCase()} | 3920/221/406
                </div>
              </div>
